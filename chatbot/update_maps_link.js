...
// Find the address question and update it
const addressIndex = faqs.findIndex(f => f.Question.toLowerCase().includes('address') || f.Question.toLowerCase().includes('location'));
const mapLink = "https://maps.app.goo.gl/ce0d2f0499621061"; // Shortened version of the provided link or the full one
...
console.log('faqs.xlsx updated with Google Maps link!');
